...
param_grid = {'max_depth': [None, 3, 4, 5, 6, 7, 8],
              'random_state': [0],
...
print("MSE: ", -grid_search.cv_results_['mean_test_neg_mean_squared_error'][grid_search.best_index_])