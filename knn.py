...
# Crea l'oggetto KNeighborsRegressor
...
param_grid = {'n_neighbors': [3, 5, 7],
              ...
              'algorithm': ['kd_tree'],
              'p': [2], # p=2 applica la distanza euclidea
              'leaf_size': [20, 30, 40]}
...
pd.DataFrame(results).to_csv(f"risultati/risultati_knn_{nome_dataset}")
for metric in [
...
# Calcola la feature importance utilizzando ANOVA
f, p_values = f_regression(data[features], data[target])
...
print("Feature importance in ordine decrescente:")
